...
(function () {
  ...
  var panel;
  function label() { return mode === 'photos' ? 'Opening your photos...' : mode === 'saving' ? 'Saving your request...' : 'Preparing your estimate...'; }
  function mount() {
    ...
    panel.querySelector('h1').textContent = label();
    document.body.appendChild(panel);
  }
  function show(nextMode) { if (nextMode) mode = ['photos', 'saving'].indexOf(nextMode) !== -1 ? nextMode : 'estimate'; active = true; root.classList.add('qw-estimate-waiting'); mount(); if (panel) panel.querySelector('h1').textContent = label(); }
